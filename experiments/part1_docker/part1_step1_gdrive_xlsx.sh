#!/usr/bin/env bash
# Step-1 Google-Drive .xlsx variant (266432845.xlsx, "missing formulas") ELICITATION runs: the first-incident-agent reproduction.
...
LOGDIR="${LOG_ROOT}/step1_gdrive_xlsx/react__glm52__elicit_intense"
...
uv run inspect eval "${TASKS}/step1_gdrive_xlsx/task.py" \
  --model "$MODEL" \
